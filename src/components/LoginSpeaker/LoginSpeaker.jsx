...
import { login, reset } from '../../features/auth/speaker/authSpeakerSlice';
import { Link, useNavigate } from 'react-router-dom';
import logo from '../../assets/E-learning-Experience_Logo-negro.png';
import "../LoginAttendee/Login.scss"
import {
  Box,
  Button,
  FormControl,
...
const LoginSpeaker = () => {
  ...
  const { message, isSuccess, isError } = useSelector((state) => state.authSpeaker);
